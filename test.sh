...
# Run this after touching kernel_bridge.gd, graph_view.gd, export_presets.cfg, or the game's own
# graph_kernel.mjs.
set -euo pipefail
...
SPIKE_CHROME_PATH="$SPIKE_CHROME_PATH" "$PYTHON_BIN" "$SPIKE_DIR/verify_bridge.py" "http://localhost:$PORT/index.html"
